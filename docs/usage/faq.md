...
Not yet as a polished public product. The current `1.1` build is a local
...
The `1.1` release is unsigned and non-notarized. macOS Gatekeeper may
...
The `1.1` release adds workspace inspection paths for git status,
